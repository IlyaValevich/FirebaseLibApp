...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func openViewController(){
        ...
        if Auth.auth().currentUser != nil{
            UserService.observeUserProfile(Auth.auth().currentUser!.uid, completion: { userProfile in
            ...
            let controller = storyboard.instantiateViewController(withIdentifier: "MenuLoginViewController") as! MenuLoginViewController
            self.window?.rootViewController = controller
            self.window?.makeKeyAndVisible()
        }
    }
